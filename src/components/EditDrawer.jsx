...
const EditDrawer = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const newCourse = {
      ...
      short_name: short_nameRef.current.value,
  ...
  return (
    ...
    <div
      id="edit-drawer"
      className={`fixed top-0 right-0 shadow-sm z-40 h-screen p-4 overflow-y-auto transition-transform  bg-white w-80 dark:bg-gray-800 ${
